...
parser.add_argument(
    "--test_data_path", default="/data/kyle/Dental/DATA/nnUNet/nnUNet_raw/Dataset116_ToothFairy2cropped/imagesTs/", type=str, help="test_data_path")
parser.add_argument(
    "--save_prediction_path", default="/data/kyle/Dental/DATA/nnUNet/nnUNet_raw/Dataset116_ToothFairy2cropped/predLabelsTr_vocoDBT/", type=str, help="test_prediction_path")
parser.add_argument(
    "--trained_pth", default="runs/dbt/model.pt", type=str, help="trained checkpoint directory")
