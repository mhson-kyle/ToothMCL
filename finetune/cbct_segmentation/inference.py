...
def parse_args():
    ...
    parser.add_argument(
        "--test_data_path", default="/ssddata/data/mhson/DATA/CBCT/Dataset125_NC/imagesTs/", type=str, help="test_data_path")
    parser.add_argument(
        "--save_prediction_path", default="/ssddata/data/mhson/DATA/CBCT/Dataset125_NC/predLabelsTs_ours08/", type=str, help="test_prediction_path")
    parser.add_argument(
        "--trained_pth", default="runs/logs_swin_base_ours_0.8/model_final.pt", type=str, help="trained checkpoint directory")
    ...
    parser.add_argument("--space_x", default=0.3, type=float, help="spacing in x direction")
    parser.add_argument("--space_y", default=0.3, type=float, help="spacing in y direction")
    parser.add_argument("--space_z", default=0.3, type=float, help="spacing in z direction")
...
def get_test_loader(args):
    ...
    dataset_list = sorted(os.listdir(args.test_data_path))
...
def main():
    ...
    with torch.no_grad():
        for idx, batch_data in enumerate(test_loader):
            ...
            os.rename(os.path.join(args.save_prediction_path, name.replace('.nii.gz', '_trans.nii.gz')),
                      os.path.join(args.save_prediction_path, name.replace('_trans.nii.gz', '.nii.gz')))
