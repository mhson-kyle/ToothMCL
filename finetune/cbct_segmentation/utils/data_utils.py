...
def get_loader(args):
    ...
    train_transform = transforms.Compose(
        [
            ...
            transforms.RandRotated(keys=["image", "label"], range_x=(-0.5, 0.5), range_y=(-0.5, 0.5), range_z=(-0.5, 0.5), prob=0.7, keep_size=True, mode=("bilinear", "nearest")),
            transforms.RandGaussianNoised(keys="image", prob=0.5, std=0.1, mean=0),
