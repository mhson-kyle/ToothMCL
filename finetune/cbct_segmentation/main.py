...
parser.add_argument("--name", default='Ours', help="the name of pre-trained model !!!!!!!!")
...
parser.add_argument("--data_dir", default="/data/3Dircadb1_convert/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./toothfairy2.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/3D-IRCADb', type=str, help="dataset json file")
