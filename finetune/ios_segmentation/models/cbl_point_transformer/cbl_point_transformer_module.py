...
class PointTransformerSeg(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.block_num==5:
            ...
            # print(p1.shape, x1.shape, o1.shape)
            # print(p2.shape, x2.shape, o2.shape)
            # print(p3.shape, x3.shape, o3.shape)
            # print(p4.shape, x4.shape, o4.shape)
            ...
            down_list = [
                ...
                {'p_out': p5, 'f_out': x5, 'offset': o5},6  # n_4 - fdims = 512
            ]
